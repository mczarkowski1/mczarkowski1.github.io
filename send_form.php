...
if($name && $email && $phone && $message){
 ...
 $message_body="Formularz kontaktowy wysłany ze strony www.mczarkowski.com\n";
 $message_body.="Imię i nazwisko: $name\n";
 $message_body.="Adres email: $email\n";
 $message_body.=$message;
 if(mail("mczarkowski.kontakt@gmail.com","Formularz kontaktowy",$message_body,$headers)){
 $json=array("status"=>1,"msg"=>"<p class='status_ok'>Wiadomość została wysłana!</p>");
 }
 else{
